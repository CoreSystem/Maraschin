 ...
 * @version v1.0
 */
public class ConfiguraBanco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtIPServidor.setNextFocusableComponent(btnSelecionaBanco);
        ...
        txtCaminhoBanco.setNextFocusableComponent(btnOk);
        ...
        btnSelecionaBanco.setNextFocusableComponent(btnOk);
    ...
    private void btnSelecionaBancoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSelecionaBancoActionPerformed
        ...
        flc.setFileFilter(new FileNameExtensionFilter("Banco de Dados \".GDB\" ou \".FDB\"", new String[]{"gdb", "fdb"}));
